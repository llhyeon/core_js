...
export function createTag({ id, username = 'unknown', email = 'unknown@unknown.com', website = 'unknown.co.kr' }) {
  const tag = /* html */ `
  <article class="user-card" data-index="user-${id}">
    ...
    <div class="user-resouce-info">
      ...
      <div>
        <a class="user-website" href="${website}" target="_blank" rel="noopener noreferer">
          ${website}
        </a>
      </div>
    </div>
...
export function createEmptyCard(errorMessage = '데이터 정보를 불러오지 못 했습니다.') {
  const tag = /* html */ `
